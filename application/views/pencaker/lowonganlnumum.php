      ...
      <?php 
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="box">
              ...
              <p>
                <a href="pencaker/lihatlokerlnumum/<?php echo $row->id_lowongan ?>" class="btn btn-warning">Lihat</a>
                <a href="pencaker/lamarlokerlnumum/<?php echo $row->id_lowongan ?>" class="btn btn-danger">Lamar</a>
              </p>
            </div>
          </div>
          <?php } ?>
