        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-2 col-6 footer-links">
            ...
            <ul>
              ...
              ?>
              <li><i class="bi bi-chevron-right"></i> <a href="home/pelatihanumum"><?php echo $xrowx->nama_pelatihan ?></a></li>
               <?php } ?>
            </ul>
          </div>
...
<?php if($this->session->flashdata('msg') == 'simpan'){ ?>
  ...
  <?php } ?>
  <?php if($this->session->flashdata('msg') == 'lamar'){ ?>
  <script>
    Swal.fire(
      "Informasi",
      "Selamat, Anda berhasil lamar lowongan ini!",
      "success"
    );
  </script>
  <?php } ?>

   <?php if($this->session->flashdata('msg') == 'sudahlamar'){ ?>
  <script>
    Swal.fire(
      "Informasi",
      "Maaf, Anda Sudah Pernah Lamar Lowongan Ini",
      "error"
    );
  </script>
  <?php } ?>

  <?php if($this->session->flashdata('msg') == 'sudahlamarpelatihan'){ ?>
  <script>
    Swal.fire(
      "Informasi",
      "Maaf, Anda Sudah Pernah Daftar Pelatihan Ini",
      "error"
    );
  </script>
  <?php } ?>
