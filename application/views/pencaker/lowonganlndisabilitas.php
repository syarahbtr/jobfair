<main id="main">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li>Lowongan Luar Negeri Disabilitas</li>
        </ol>
        <h2>Lowongan Luar Negeri</h2>
    ...
    <div class="row">
      <?php 
                // $today= date("Y-m-d"); 
                // $q=$this->db->query("select lowongan.*,user.nama_user,user.foto_user,jabatan.nama_jabatan,sektor.nama_sektor,pendidikan.nama_pendidikan from lowongan 
                ...
                //         and lowongan.status='ACC' and lowongan.disediakanuntuk='Disabilitas'
                //         ");
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="box">
              ...
              <p>
                <a href="pencaker/lihatlokerlndisabilitas/<?php echo $row->id_lowongan ?>" class="btn btn-warning">Lihat</a>
                <a href="pencaker/lamarlokerlndisabilitas/<?php echo $row->id_lowongan ?>" class="btn btn-danger">Lamar</a>
              </p>
            </div>
          </div>
          <?php } ?>
