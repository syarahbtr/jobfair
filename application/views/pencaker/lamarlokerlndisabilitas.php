<main id="main">
    <?php 
                ...
                $q=$this->db->query("select lowongan.*,user.nama_user,user.foto_user,sektor.nama_sektor,pendidikan.nama_pendidikan from lowongan 
                        ...
                        where lowongan.jenis_lowongan='Luar Negeri' and lowongan.tgl_tutup_loker>='$today' and lowongan.id_lowongan='$id'
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li>Lamar Lowongan Luar Negeri Umum</li>
        </ol>
        <h2>Lamar Lowongan Luar Negeri Umum</h2>
    ...
    <div class="card">
    <div class="card-body">
        <form action="pencaker/updatelamarlokerlndisabilitas" method="post" enctype="multipart/form-data">
            <table class="table">
                <tr>
                ...
                <tr>
                    <td><button type="submit" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Melamar?')">Lamar</button></td>
                </tr>
