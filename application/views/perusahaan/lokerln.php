    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        <div class="card-body table-responsive">
          <a href="perusahaan/eksportpdflokerln" class="btn btn-primary mb-3"><i class="fa fa-download"></i> Eksport PDF</a>
            ...
            <tbody>
              ...
              ?>
                <tr align=center>
                  ...
                  <td width=25%>
                    <a href="perusahaan/pelamarln/<?php echo $row->id_lowongan ?>" class="btn btn-primary">
                      Pelamar <span class="badge badge-light"><?php echo $lamar->jml ?></span>
                    </a>
                  </td>
                  <td>
                    <a href="perusahaan/hapuslokerln/<?php echo $row->id_lowongan ?>" class="btn btn-danger hapus"><i class="fa fa-trash"></i></a>
                    <a href="perusahaan/editlokerln/<?php echo $row->id_lowongan ?>" class="btn btn-success"><?php echo $row->status ?> <i class="fa fa-edit"></i></a>
                    <a href="perusahaan/detaillokerln/<?php echo $row->id_lowongan ?>" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                  </td>
                </tr>
              <?php $no++;
              } ?>
