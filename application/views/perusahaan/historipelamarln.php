        ...
        <div class="card-body table-responsive">
          <table class="table table-hover dttable">
            ...
            <tbody>
              ...
              ?>
               <a href="perusahaan/eksportpdfpelamarln/<?php echo $k->id_lowongan ?>" class="btn btn-primary mb-3" target="_blank"><i class="fa fa-download"></i> Eksport PDF</a>
                <tr align=center>
                  <td><?php echo $no; ?></td>
                  <?php 
                  ...
                  <td>
                    <a href="perusahaan/detailhistoripelamarln/<?php echo $this->uri->segment(3).'/'.$row->user_id ?>" class="btn btn-warning"><?php echo $row->nama_status_lamar ?><i class="fa fa-eye"></i></a>
                  </td>
