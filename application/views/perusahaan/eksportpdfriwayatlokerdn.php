...
$sqldetil = $this->db->query("select lowongan.*,
                        user.id_user,user.nama_user from lowongan 
                         ...
                         where lowongan.jenis_lowongan='Dalam Negeri' and lowongan.tgl_tutup_loker<='$today' OR lowongan.status='Tutup Lowongan' and lowongan.jenis_lowongan='Dalam Negeri'
                         ");
//body

$pdf->SetFont('Times','B',14);
$pdf->Cell(0,5,'LAPORAN DATA RIWAYAT LOWONGAN KERJA DALAM NEGERI',0,1,'C');	
$pdf->Cell(30,8,'',0,1);
...
$pdf->Output('Data Riwayat Lowongan Kerja Dalam Negeri.pdf', 'I');