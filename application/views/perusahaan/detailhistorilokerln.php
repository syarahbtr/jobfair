...
<div class="main-content">
  <?php
  $q = $this->db->query("select lowongan.*,user.nama_user,sektor.nama_sektor,pendidikan.nama_pendidikan from lowongan 
    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="perusahaan/historiln" class="btn btn-danger mr-2"><i class="fa fa-sync-alt"></i>Kembali</a>
        </div>
      </div>
    </div>
  </section>
