    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        <div class="card-body table-responsive">
          <a href="perusahaan/eksportpdflokerdn" class="btn btn-primary mb-3"><i class="fa fa-download"></i> Eksport PDF</a>
            ...
            <tbody>
              ...
              ?>
                <tr align=center>
                  ...
                  <td width=25%>
                    <a class="btn btn-primary" href="perusahaan/pelamardn/<?php echo $row->id_lowongan ?>" role="button">
                      Pelamar<span class="badge badge-light">
                        <?php echo $lamar->jml ?></span></a>
                  </td>
                  <td>
                    <a href="perusahaan/hapuslokerdn/<?php echo $row->id_lowongan ?>" class="btn btn-danger hapus"><i class="fa fa-trash"></i></a>
                    <a href="perusahaan/editlokerdn/<?php echo $row->id_lowongan ?>" class="btn btn-success"><?php echo $row->status ?> <i class="fa fa-edit"></i></a>
                    <a href="perusahaan/detaillokerdn/<?php echo $row->id_lowongan ?>" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                  </td>
                </tr>
              <?php $no++;
              } ?>
