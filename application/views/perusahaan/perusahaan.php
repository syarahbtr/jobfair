           ...
           <div class="card author-box">
             <div class="card-body">
               <div class="author-box-center">
                 <img alt="image" src="<?php echo base_url('image/') . $row->foto_user ?>" class="rounded-circle author-box-picture">
           ...
           <div class="card">
             <div class="padding-20">
               <ul class="nav nav-tabs" id="myTab2" role="tablist">
                 <li class="nav-item">
                   <a class="nav-link active" id="home-tab2" data-toggle="tab" href="#about" role="tab" aria-selected="true">Profile</a>
                 </li>
                 <li class="nav-item">
               ...
               <div class="tab-content tab-bordered" id="myTab3Content">
                 <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab2">
                   <table class="table">
                     ...
                     <tr>
                       ...
                       <td><input type="text" class="form-control" readonly value="<?php echo $row->nama_jbu ?>" name="jbu"></td>
                     </tr>
                     <tr>
                       <td>Nomor Induk Berusaha</td>
                       <td><input type="text" class="form-control" readonly value="<?php echo $row->nib ?>" name="nib"></td>
                     </tr>
                     <tr>
                       <td>Sektor</td>
                       <td><input type="text" class="form-control" readonly value="<?php echo $row->nama_sektor ?>" name="id_sektor"></td>
                     </tr>
                     <tr>
                       <td>Alamat</td>
                     ...
                     <tr>
                       ...
                       <td><input type="text" class="form-control" readonly value="<?php echo $row->nama_pj ?>" name="nama_pj"></td>
                     </tr>
                     <tr>
                       <td>No Telepon Penanggung Jawab</td>
                       <td><input type="text" class="form-control" readonly value="<?php echo $row->nohp_pj ?>" name="nohp_pj"></td>
                     </tr>
                     <tr>
                       <td>Jabatan Penanggung Jawab</td>
                       <td><input type="text" class="form-control" readonly value="<?php echo $row->jabatan_pj ?>" name="jabatan_pj"></td>
                     </tr>
                     <tr>
                       <td>Deskripsi Perusahaan</td>
                       <td><input type="text" class="form-control" readonly value="<?php echo $row->deskripsi_perusahaan ?>" name="deskripsi_perusahaan"></td>
                     </tr>
                 ...
                 <div class="tab-pane fade" id="settings" role="tabpanel" aria-labelledby="profile-tab2">
                   ...
                   <div class="card-body">
                     <form action="perusahaan/updateprofile" method="post" enctype="multipart/form-data">
                       <table class="table">
                         <tr>
                           <td>Nama</td>
                         ...
                         <tr>
                           ...
                           <td>
                             <select name="jbu" required class=form-control id="">
                               <option value="<?php echo $row->id_jbu ?>"><?php echo $row->nama_jbu ?></option>
                               <?php
                                $q = $this->db->query('select * from jenis_badan_usaha');
                                foreach ($q->result() as $rowjbu) {
                                ?>
                                 <option value="<?php echo $rowjbu->id_jbu ?>"><?php echo $rowjbu->nama_jbu ?></option>
                               <?php
                                }
                                ?>
                             </select>
                         ...
                         <tr>
                           <td>Nomor Induk Berusaha</td>
                           <td><input type="number" class="form-control" value="<?php echo $row->nib ?>" name="nib"></td>
                         </tr>
                         <tr>
                           <td>Sektor</td>
                           <td>
                             <select name="id_sektor" required class=form-control id="">
                         ...
                         <tr>
                           <td>Nama Penanggung Jawab</td>
                           <td><input type="text" class="form-control" value="<?php echo $row->nama_pj ?>" name="nama_pj"></td>
                         </tr>
                         <tr>
                           <td>No Telepon Penanggung Jawab</td>
                           <td><input type="number" class="form-control" value="<?php echo $row->nohp_pj ?>" name="nohp_pj"></td>
                         </tr>
                         <tr>
                           <td>Jabatan Penanggung Jawab</td>
                           <td><input type="text" class="form-control" value="<?php echo $row->jabatan_pj ?>" name="jabatan_pj"></td>
                         </tr>
                         <tr>
                           <td>Deskripsi Perusahaan</td>
                           <td><input type="text" class="form-control" value="<?php echo $row->deskripsi_perusahaan ?>" name="deskripsi_perusahaan"></td>
                         </tr>
                         <tr>
                           <td></td>
                           <td>
