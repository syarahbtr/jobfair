    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        <div class="card-body table-responsive">
           <a href="perusahaan/eksportpdfpelamarln/<?php echo $id ?>" class="btn btn-primary mb-3" target="_blank"><i class="fa fa-download"></i> Eksport PDF</a>
            ...
            <tbody>
              ...
              ?>
                <tr align=center>
                  ...
                  <td>
                    <a href="perusahaan/detailpelamarln/<?php echo $this->uri->segment(3) . '/' . $row->user_id ?>" class="btn btn-warning"><?php echo $row->nama_status_lamar ?><i class="fa fa-eye"></i></a>
                  </td>
