...
<div class="main-content">
  ...
  $q = $this->db->query("select lowongan.*,sektor.nama_sektor,pendidikan.nama_pendidikan from lowongan 
                        ...
                        where lowongan.id_lowongan='$id' and lowongan.jenis_lowongan='Luar Negeri'
                        ");
  $row = $q->row();
  ?>
  <section class="section">
    <div class="section-body">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="perusahaan/updatelokerln/<?php echo $id ?>" method="post" enctype="multipart/form-data">
            <table class="table">
              <tr>
              ...
              <tr>
                <td>Tanggal Mulai</td>
                <td>
                  <input type="date" required class="form-control" value='<?php echo $row->tgl_buka_loker ?>' name=tgl_buka_loker>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="perusahaan/lokerln" class="btn btn-danger mr-2"><i class="fa fa-sync-alt"></i> Kembali</a>
                </td>
              </tr>
            </table>
          </form>
