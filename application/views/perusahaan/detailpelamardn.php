...
<div class="main-content">
  ...
  $q = $this->db->query("select lamar.*,user.*,pencari_kerja.*,pendidikan.nama_pendidikan,
                            ...
                            where lamar.id_user='$id' and lamar.id_lowongan='$lowongan'");
  $row = $q->row();
  ?>
        ...
        <div class="card-body">
          <table class="table table-bordered">
           ...
           <tr>
            ...
            <form action="perusahaan/ubahstatuspelamardn/<?= $this->uri->segment(3) ?>" method="post">
              <tr class="table-info">
                <input type="hidden" class="form-control" name="id_lamar" value="<?php echo $row->id_lamar ?>">
                ...
                <td>
                  ...
                  <input type="hidden" name="id_lamar" value="<?php echo $row->id_lamar ?>">
                </td>
              </tr>
              <tr>
                <td>
