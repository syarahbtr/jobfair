<main id="main">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li>Deatil Lowongan Luar Negeri Umum</li>
        </ol>
        <h2>Detail Lowongan Luar Negeri Umum</h2>
    ...
    <div class="card-body">
        ...
        <br>
        <a href="home/lamarlokerlnumum/<?php echo $row->id_lowongan ?>" class="btn btn-danger">Lamar</a>
    </div>
    </div>
    </div>
    </div>
