          ...
          <div class="section-body">
            ...
            <div class="card">
               ...
               Ubah Password
                ...
                <div class="card-body">
                   <form action="admin/ubahpasswordbaru" method="post" enctype="multipart/form-data" >
                       <table class="table">
                            <tr>
                             ...
                             <tr>
                                ...
                                <td><input type="password" required class="form-control" name=password1>
                                <div class="form-text">Password minimal 8 karakter</div>
                                <?php echo form_error('password1','<small class="text-danger">','</small>')?>
                            </td>
                            </tr>
                             <tr>
                                <td>Konfirmasi Password Baru <span class="text-danger">*</span></td>
                                <td><input type="password" required class="form-control" name=password2>
                                <div class="form-text">Password minimal 8 karakter</div>
