<!-- Main Content -->
      <div class="main-content">
        ...
        $q=$this->db->query("select lowongan.*,user.id_user,user.nama_user,sektor.nama_sektor,pendidikan.nama_pendidikan from lowongan 
                        ...
                        where lowongan.jenis_lowongan='Dalam Negeri' and lowongan.id_lowongan='$id'
                        ");
          ...
          <div class="section-body">
            ...
            <tr>
              ...
              <td><?php echo $row->lokasi_wawancara ?></td>
                   ...
                   <a href="admin/historilokerdn" class="btn btn-danger mr-2"><i class="fa fa-sync-alt"></i>Kembali</a>
                </div>
            </div>
          </div>
        </section>
