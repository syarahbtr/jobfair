  ...
  <section class="section">
    <div class="section-body">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <a href="admin/eksportpdfhistoripelamardn/<?php echo $id ?>" class="btn btn-primary mb-3" target="_blank"><i class="fa fa-download"></i> Eksport PDF</a>
              ...
              ?>
                <tr align=center>
                  ...
                  <!-- <td width=45%>
                   ...
                   <td >
                        <a href="admin/detailhistoripelamardn/<?php echo $this->uri->segment(3).'/'.$row->user_id ?>" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                    </td>
                </tr>
              <?php $no++;
              } ?>
