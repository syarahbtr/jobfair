        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="card-body table-responsive">
              <a href="admin/eksportpdflokerdn" class="btn btn-primary mb-3"><i class="fa fa-download"></i> Eksport PDF</a>
                ...
                <thead>
                    ...
                    <tbody>
                        ...
                        <tr align=center>
                            ...
                            <td width=25%>
                            <a href="admin/pelamarlokerdn/<?php echo $row->id_lowongan?>" class="btn btn-primary">
                            Pelamar <span class="badge badge-light"><?php echo $lamar->jml?></span>
                            </a>
                            </td>
                            <td>
                                <a href="admin/ubahlokerdn/<?php echo $row->id_lowongan ?>" class="btn btn-warning"><?php echo $row->status?><i class="fa fa-eye"></i></a>
