...
$pdf->Cell(0,5,'LAPORAN DATA RIWAYAT LOWONGAN DALAM NEGERI',0,1,'C');	
$pdf->Cell(30,8,'',0,1);
...
$pdf->Cell(110,6,'Judul Lowongan',1,0, 'C');
...
foreach($sqldetil->result() as $d){
        ...
        $pdf->Cell(110,6,$d->judul_lowongan,1,0);
        $pdf->Cell(55,6,$d->jurusan,1,0);
        $pdf->Cell(25,6,$d->jumlah,1,1);
}

$pdf->SetFont('Times','',10);

$pdf->Output('Riwayat Lowongan Kerja Dalam Negeri.pdf', 'I');