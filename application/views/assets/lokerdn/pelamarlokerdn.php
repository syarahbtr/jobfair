  ...
  <section class="section">
    <div class="section-body">
      ...
      <div class="card">
        ...
        <div class="card-body">
           <a href="admin/eksportpdfpelamardn/<?php echo $id ?>" class="btn btn-primary mb-3" target="_blank"><i class="fa fa-download"></i> Eksport PDF</a>
          <table class="table table-hover dttable">
            ...
            <tbody>
              <?php
              $no = 1;
              $q = $this->db->query("select lamar.*,user.*,user.id_user as user,status_pelamar.nama_status_lamar,pencari_kerja.*,
              ...
              ?>
                ...
                <tr align=center>
                  ...
                  <!-- <td width=45%>
                   ...
                   <td >
                        <a href="admin/detailpelamardn/<?php echo $this->uri->segment(3).'/'.$row->id_user ?>" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                    </td>
                </tr>
              <?php $no++;
              } ?>
