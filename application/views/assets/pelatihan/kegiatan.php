          ...
          <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body table-responsive">
                  <a href="admin/eksportpdfpelatihan" class="btn btn-primary mb-3"><i class="fa fa-download"></i> Eksport PDF</a>
                    <br>            
                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            $no=1;
                            $today= date("Y-m-d");
                            $q=$this->db->query("select pelatihan.*,user.id_user,user.nama_user from pelatihan 
                            ...
                            ?>
                                <tr align=center>
                                    ...
                                    <td> <?php  $originalDate = $row->tanggal_selesai;
                                     ...
                                     <td width=15%>
                                     <a href="admin/pendaftarpelatihan/<?php echo $row->id_pelatihan?>" class="btn btn-primary">
                                    Pelamar <span class="badge badge-light"><?php echo $row->jumlah_peserta?></span>
                                    </a>
                                    </td>
                                    <td width=15%>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                    <!-- <a href="admin/hapuspelatihan/<?php echo $row->id_pelatihan ?>"  class="btn btn-danger hapus"><i class="fa fa-trash"></i></a> -->
                                    <a href="admin/ubahpelatihan/<?php echo $row->id_pelatihan ?>" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                                    </div>
                                    </td>
                                </tr>
                            <?php $no++; } ?>
