        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                  <a href="admin/eksportpdfpendaftar/<?php echo $id ?>" class="btn btn-primary mb-3"><i class="fa fa-download"></i> Eksport PDF</a>
                    <br>            
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align=center>
                                    ...
                                    <td >
                                        <a href="admin/detailpendaftar/<?php echo $this->uri->segment(3).'/'.$row->id_user ?>" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                                    </td>
