        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                   <a href="admin/eksportpdfhistoripendaftar" class="btn btn-primary mb-3"><i class="fa fa-download"></i> Eksport PDF</a>
                    <br>            
                    ...
                    <thead>
                        ...
                        <tbody>
                            <?php
                            $no=1;
                            $q=$this->db->query("select daftar_pelatihan.*,user.*,pencari_kerja.*,pendidikan.nama_pendidikan from daftar_pelatihan
                            ...
                            ?>
                                <tr align=center>
                                    ...
                                    <td >
                                        <a href="admin/historidetailpendaftar/<?php echo $this->uri->segment(3).'/'.$row->id_user ?>" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                                    </td>
