          ...
          <div class="section-body">
            ...
            <div class="card">
                <div class="card-header bg-primary text-light">
                    Riwayat Lowongan Kerja Luar Negeri
                </div>
            <div class="card-body table-responsive">
              <a href="admin/eksportpdfhistorilokerln" class="btn btn-primary mb-3"><i class="fa fa-download"></i> Eksport PDF</a>
            <Table class="table table-hover dttable">
                <thead>
                    ...
                    <tbody>
                        ...
                        // where lowongan.jenis_lowongan='Luar Negeri' and 
                        ...
                        <tr align=center>
                            ...
                            <td width=25%>
                            <a href="admin/pelamarhistorilokerln/<?php echo $row->id_lowongan?>" class="btn btn-primary">
                            ...
                            <td >
                                ...
                                <a href="admin/lihatlokerln/<?php echo $row->id_lowongan ?>" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                            </td>
                        </tr>
                        <?php $no++;} ?>
                    </tbody>
