<!-- Main Content -->
      <div class="main-content">
        ...
        $q=$this->db->query("select lowongan.*,user.nama_user,sektor.nama_sektor,pendidikan.nama_pendidikan from lowongan 
                        ...
                        where lowongan.jenis_lowongan='Luar Negeri' and lowongan.id_lowongan='$id'
                        ");
          ...
          <div class="section-body">
            ...
            <tr>
              ...
              <td><?php echo $row->lokasi_wawancara ?></td>
                   ...
                   <a href="admin/historilokerln" class="btn btn-danger mr-2"><i class="fa fa-sync-alt"></i>Kembali</a>
                </div>
            </div>
          </div>
        </section>
