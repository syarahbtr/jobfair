...
$today = date("Y-m-d");
$sqldetil = $this->db->query("select * from user  where level='3' order by id_user desc");

$pdf->SetFont('Times','B',14);
$pdf->Cell(0,5,'LAPORAN DATA PENYEDIA PELATIHAN',0,1,'C');	
$pdf->Cell(30,8,'',0,1);
...
$pdf->Output('Data Penyedia Pelatihan.pdf', 'I');