<!-- Main Content -->
      <div class="main-content">
        <?php 
        $q=$this->db->query("select penyedia_pelatihan.*,user.* from penyedia_pelatihan 
        inner join user on user.id_user=penyedia_pelatihan.id_user where penyedia_pelatihan.id_user='$id'");
        $row=$q->row();
        ?>
                ...
                <div class="card-body">
                  <table class="table table-bordered" >
                    <tr>
                        <td colspan="2">
                        <center>
                          <img src="image/<?php echo $row->foto_user ?>" width="250" class="img img-thumbnail img-fluid rounded-circle" alt="">
                        </center>
                        </td>
                    </tr>  
                    <tr>
