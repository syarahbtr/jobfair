...
//head
$pdf->SetLineWidth(1);
$pdf->Line(1,37,300,37);
$pdf->SetLineWidth(0);
$pdf->Line(1,37,300,37);
$pdf->Cell(30,17,'',0,1);
$pdf->SetFont('Times','B',11);
$today = date("Y-m-d");
$sqldetil = $this->db->query("select * from user  where level='4' order by id_user desc");

$pdf->SetFont('Times','B',14);
$pdf->Cell(0,5,'LAPORAN DATA PENCARI KERJA',0,1,'C');	
$pdf->Cell(30,8,'',0,1);
...
$pdf->Output('Data Pencari Kerja.pdf', 'I');