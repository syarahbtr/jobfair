        ...
        <section class="section">
          <div class="section-body">
            ...
            <div class="card">
                ...
                Edit Data Management Officer
                 </div>
                <div class="card-body">
                   <form action="admin/updatemofficer/<?php echo $id ?>" method="post" enctype="multipart/form-data" >
                       <table class="table">
                            <tr>
                                <td>Nama</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="admin/mofficer" class="btn btn-danger mr-2"><i class="fa fa-sync-alt"></i> Kembali</a>
                                </td>
                            </tr>
                       </table>
                   </form>
