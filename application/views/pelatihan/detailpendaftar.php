<!-- Main Content -->
      <div class="main-content">
        ...
        //                     agama.nama_agama,status_perkawinan.nama_status_perkawinan,jabatan.nama_jabatan from daftar_pelatihan
            ...
            <tr>
              ...
              <td>
                ...
                ?>
                   ...
                   <a href="pelatihan/pendaftarpelatihan/<?php echo $this->uri->segment(3)?>" class="btn btn-danger mr-2"><i class="fa fa-sync-alt"></i>Kembali</a>
                </div>
            </div>
          </div>
        </section>
