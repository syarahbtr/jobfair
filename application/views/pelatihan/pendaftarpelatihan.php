          ...
          <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body table-responsive">
                  <?php
                   $q=$this->db->query("select daftar_pelatihan.*,user.*,pencari_kerja.*,pendidikan.nama_pendidikan,pelatihan.id_pelatihan 
                  ...
                  ?>
                  <a href="pelatihan/eksportpdfpendaftar/<?php echo $id ?>" class="btn btn-primary mb-3" target="_blank"><i class="fa fa-download"></i> Eksport PDF</a>
                    <br>            
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr align=center>
                                    ...
                                    <td >
                                        <a href="pelatihan/detailpendaftar/<?php echo $this->uri->segment(3).'/'.$row->id_user ?>" class="btn btn-warning"><i class="fa fa-eye"></i></a>
                                    </td>
